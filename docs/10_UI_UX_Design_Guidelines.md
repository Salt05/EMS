# EMS — Hệ Thống Thiết Kế & Hướng Dẫn UI/UX

(EMS Design System & UI/UX Guidelines)

Tài liệu này định nghĩa ngôn ngữ thiết kế đồng nhất và các tiêu chuẩn UI/UX áp dụng cho toàn bộ hệ thống EMS, bao gồm cả phân hệ **Admin/Organizer Portal** (Blazor WASM) và **Student/Attendee Portal** (ASP.NET MVC).
...
### 3. Nút Bấm & Trạng Thái Tương Tác Premium
